...
import 'package:barbermate/features/admin/views/barbershops_reviews_page.dart';
import 'package:barbermate/features/admin/views/widgets/haircut_card3.dart';
                      ...
                      Column(
                        children: [
                          ...
                          OutlinedButton(
                            onPressed: () async {
                              Get.to(() =>
                                  ReviewsPageFromAdmin(barbershop: barbershop));
                            },
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                        ...
                        if (adminController.isLoading.value) {
                          ...
                          return GridView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              return HaircutCard3(haircut: barbershopHaircut);
                            },
                          );
                        }
                      }),
